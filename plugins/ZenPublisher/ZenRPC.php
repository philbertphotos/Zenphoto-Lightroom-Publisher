 ...
 * Update check
 */
function updateCheck( $args ) //TODO
{
	$args = decode64( $args );
	//logger( 'updateCheck', ( $args[ 'loglevel' ] ) );
	debugLog ('updateCheck'.var_export( $args, true ));
// The base location from where to retrieve new versions of this script
  $updatebase = "https://raw.github.com/philbertphotos/Zenphoto-Lightroom-Publisher/4.5.0/plugins/ZenPublisher/ZenRPC.php";
...
fwrite( $fp, $contents );
fclose( $fp );
return $args['sysversion'];
}
?>
>>>>>>> 1c86fe79a79c404c2317e37c33e4b63eeb313c1b
